...
#define PIN 20       // Define the GPIO pin connected to the NeoPixel data input
#define NUMPIXELS 46 // Number of NeoPixels in the strip //51 possible
#define MAXBRIGHTNESS 30
// Create an instance of the Adafruit_NeoPixel class
Adafruit_NeoPixel strip = Adafruit_NeoPixel(NUMPIXELS, PIN, NEO_GRB + NEO_KHZ800);

void addAdjustedDelay();
...
void loop()
{
  randomChristmasBalls(2, MAXBRIGHTNESS);
  // specialFadeEffect(1, MAXBRIGHTNESS);
}
